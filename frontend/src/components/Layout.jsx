...
import { LayoutDashboard, StickyNote, LogOut, User, Archive, Search, Bot, Info, Menu, X, Brain, Share2 } from 'lucide-react';
...
export default function Layout() {
    ...
    const navItems = [
        ...
        { path: '/graph', name: 'Knowledge Graph', icon: <Share2 size={20} /> },
